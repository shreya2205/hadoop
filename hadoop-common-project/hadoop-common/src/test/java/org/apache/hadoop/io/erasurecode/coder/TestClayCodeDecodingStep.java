...
//  @Test
  public void testGetAllIntersectionScore() {
    ...
    assertEquals(util.getAllIntersectionScores().get(0),new ArrayList<>(Arrays.asList(2,6)));
    assertEquals(util.getAllIntersectionScores().get(1),new ArrayList<>(Arrays.asList(0,3,4,7)));
